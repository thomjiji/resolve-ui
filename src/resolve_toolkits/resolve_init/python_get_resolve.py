...
def GetResolve():
    try:
        ...
        elif sys.platform.startswith("win") or sys.platform.startswith(
            "cygwin"
        ):
            import os

            expectedPath = (
                os.getenv("PROGRAMDATA")  # type: ignore
        ...
        try:
            ...
            bmd = imp.load_source(
                "DaVinciResolveScript", expectedPath + "DaVinciResolveScript.py"  # type: ignore
            )
        except ImportError:
