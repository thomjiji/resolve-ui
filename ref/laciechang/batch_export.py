...
class Project:
    ...
    def all_timelines_in_current_project(self):
        for i in range(
            1, self.project_manager.GetCurrentProject().GetTimelineCount() + 1
        ):
...
Timeline_Type = {
    ...
    "EDL - CMX 3600": {
        "suffix": ".edl",
        "type": [resolve.EXPORT_EDL, resolve.EXPORT_NONE],
    },
    "FCPXML 1.3": {
        "suffix": ".fcpxml",
        "type": resolve.EXPORT_FCPXML_1_3,
    },
    "FCPXML 1.4": {
        "suffix": ".fcpxml",
        "type": resolve.EXPORT_FCPXML_1_4,
    },
    "FCPXML 1.5": {
        "suffix": ".fcpxml",
        "type": resolve.EXPORT_FCPXML_1_5,
    },
    "FCPXML 1.6": {
        "suffix": ".fcpxml",
        "type": resolve.EXPORT_FCPXML_1_6,
    },
    "FCPXML 1.7": {
        "suffix": ".fcpxml",
        "type": resolve.EXPORT_FCPXML_1_7,
    },
    "FCPXML 1.8": {
        "suffix": ".fcpxml",
        "type": resolve.EXPORT_FCPXML_1_8,
    },
    "AAF": {
        "suffix": ".aaf",
    ...
    "EDL - CDL": {
        "suffix": ".edl",
        "type": [resolve.EXPORT_EDL, resolve.EXPORT_CDL],
    },
    "EDL - SDL": {
        "suffix": ".edl",
        "type": [resolve.EXPORT_EDL, resolve.EXPORT_SDL],
    },
    "EDL - Missing Clips": {
        "suffix": ".edl",
        "type": [resolve.EXPORT_EDL, resolve.EXPORT_MISSING_CLIPS],
    },
    "HDR10 Profile A": {
        "suffix": ".xml",
        "type": resolve.EXPORT_HDR_10_PROFILE_A,
    },
    "HDR10 Profile B": {
        "suffix": ".xml",
        "type": resolve.EXPORT_HDR_10_PROFILE_B,
    },
    "Dolby Vision 2.9": {
        "suffix": ".xml",
        "type": resolve.EXPORT_DOLBY_VISION_VER_2_9,
    },
...
project_content_or_itself = ui.HGroup(
    {"Spacing": 5, "Weight": 0},
    [
        ui.VGroup(
            {"Weight": 1},
...
timeline_level_group = ui.HGroup(
    {"Spacing": 5, "Weight": 0},
    [
        ui.VGroup(
            {"Weight": 1},
...
window_01 = ui.VGroup(
    [
        ui.Label(
            {
                "Text": "<a href='https://github.com/laciechang/resolve-batch-exporter' style='color: #FA5B4A; text-decoration: none'>批量导出工具</a>",
            ...
            [
                ui.VGroup(
                    ...
                    [
                        ...
                        ui.Label(SplitLine),
                        ui.Stack(
                            {"ID": ExportTimelineFilesGroup, "Weight": 0},
                            [
...
dlg = disp.AddWindow(
    {
        ...
        "ID": "MyWin",
        "Geometry": [100, 300, 400, 630],  # position when starting  # width, height
    },
    window_01,
)
...
itm[AllProject].Text = "当前{0}文件夹内的项目".format(
    "根" if len(Current_folder_name) == 0 else Current_folder_name
)
...
def success_dialog(folder):
    ...
    msg_main = ui.VGroup(
        ...
        [
            ui.Label(
                {"Text": msg, "Alignment": {"AlignHCenter": True, "AlignVCenter": True}}
            ),
            ui.HGroup(
                [
                    ui.HGap(),
